...
@interface KChatViewController () <KInputBoxViewCtrlDelegate, TZImagePickerControllerDelegate,KPhotoBrowserDelegate, KPhotoBrowserDatasource,
...
- (void)addMessage:(KMessageModel *)model
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSIndexPath *indexPath = [NSIndexPath indexPathForRow:self->_dataSource.count - 1 inSection:0];
        [self->_listView insertRowsAtIndexPaths:@[indexPath] withRowAnimation:0];
